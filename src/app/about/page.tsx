...
export default function AboutPage() {
  return (
    <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 space-y-12 text-foreground/80">
      {/* Title & Introduction */}
      ...
      <div className="border border-border/40 p-8 bg-muted/5 space-y-6 rounded-none">
        <h2 className="text-lg font-serif font-bold text-foreground tracking-tight flex items-center gap-2 border-b border-border/10 pb-3">
        ...
        <div className="space-y-4 text-xs font-mono leading-relaxed text-muted-foreground">
          ...
          <div className="space-y-2">
            <h3 className="font-bold text-foreground uppercase tracking-wide">Originality & Copyright Compliance</h3>
            <p>
          ...
          <div className="space-y-2">
            <h3 className="font-bold text-foreground uppercase tracking-wide">Privacy & Cookie Management</h3>
            <p>
